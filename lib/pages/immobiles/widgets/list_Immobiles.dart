            ...
            Padding(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      alignment: Alignment.center, primary: AppColors.yellow),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [const Icon(keyboard_control_outlined)],
                  ),
                  onPressed: () {
                                ...
                                StatefulBuilder(builder: (context, setStateSB) {
                                  return Column(
                                    ...
                                    children: [
                                      Text(
                                        "Valor até R\$: " +
                                            filters.valueMax.round().toString(),
                                        style: TextStyle(
                                            color: AppColors.white,
                                            fontSize: 25),
                                      ),
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) => DetailsScreen(
                                        imm: i, controller: widget.controller),
                                  ),
                                );
                              },
                              child: Padding(
